...
Our sponsors help make Advent of Code possible: Citadel Securities - Our
engineers build the tech that helps power global markets with speed, precision
and data. Every nanosecond matters. Join us at the edge of innovation (Just
don't blink. The markets won't). --- Day 1: Secret Entrance ---
